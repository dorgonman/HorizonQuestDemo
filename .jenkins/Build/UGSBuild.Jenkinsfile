...
properties([
    parameters([
        ...
        string(name: 'SENTRY_PROJECT', defaultValue: 'horizonquestdemo', description: 'Sentry project slug for this project'),
...
def cfg = [
    ...
    sentryProject: 'horizonquestdemo',
    ...
    hordeToken: '',
    hordeGitStreamRepo: 'https://dev.azure.com/kanohorizonia/UEHorizonPlugin/_git/HorizonQuestDemo',
