# Jenkins Automation for HorizonQuestDemo

This directory contains the Jenkins Pipeline configuration for the HorizonQuestDemo project. It uses a shared pipeline library to provide standardized Unreal Engine build and test workflows.
...
- `HorizonPlugin/HorizonQuestDemo/Build/Development` — `*StandaloneTestReport.tar` and `Intermediate/BuildArchive/doc/` public docs.
- `HorizonPlugin/HorizonQuestDemo/Build/UGSBuild` — `Intermediate/BuildUGS/NuGet/*.nupkg`.
